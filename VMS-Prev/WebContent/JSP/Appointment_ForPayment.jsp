...
<head>
  ...
  location.href = "${pageContext.request.contextPath}/Appointment_ForPayment";}
  </SCRIPT>
...
<body>
<form class="dark-matter" action="${pageContext.request.contextPath}/Appointment_ForPayment">
